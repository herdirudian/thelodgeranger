...
import { formatWibDate } from '@/lib/wibHelpers';
    ...
    <div ref={ref} className="p-8 bg-white max-w-4xl mx-auto print:p-0">
      ...
      <div className="flex justify-between items-start border-b pb-6 mb-6">
        ...
        <div className="text-right">
          ...
          <p className="text-gray-600">Date: <span className="font-medium text-gray-900">{formatWibDate(data.createdAt)}</span></p>
      ...
      <div className="mb-8 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p className="font-medium">{data.requiredDate ? formatWibDate(data.requiredDate) : 'N/A'}</p>
            </div>
            <div>
      ...
      {/* Attachments Section */}
      {data.attachmentUrl && (
        <div className="mb-8 p-4 bg-blue-50 border border-blue-100 rounded-lg print:hidden">
            <h3 className="text-sm font-bold text-blue-800 mb-2">Supporting Document</h3>
            <a 
                href={`${process.env.NEXT_PUBLIC_API_URL?.replace('/api', '') || 'http://localhost:5000'}${data.attachmentUrl}`} 
                target="_blank" 
      ...
      <div className="mt-12 pt-6 border-t-2 border-gray-100">
        ...
        <div className="grid grid-cols-5 gap-4">
            <div className="text-center">
                ...
                <p className="text-xs text-gray-500">Date: {formatWibDate(data.createdAt)}</p>
            </div>
      ...
      <div className="mt-12 text-center text-xs text-gray-400 border-t pt-4">
        <p>Generated by The Lodge Ranger System on {formatWibDate(new Date())}</p>
      </div>
    </div>
  );
});
